...
<head>
 <title><?php if(isset($title)) echo $title, ' :: '; echo static::FORUM_NAME ?> Message Board</title>
 <link rel="stylesheet" href="<?php echo static::fingerprint('style.css') ?>" type="text/css"/>
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
</head>
<body>
 <h1 id="header"><a href="<?php echo static::makeURI(static::PAGE_INDEX) ?>"><?php echo static::FORUM_NAME ?></a></h1>
...
</code><a class="float-right" href="/">scrap.ath.cx:99</a></p>
</body>
</html>